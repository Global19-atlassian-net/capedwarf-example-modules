...
function cd_transformer {
	...
	transformer_cp=${transformer_cp}:${cd_modules}org/hibernate/search/main/hibernate-search-engine-4.2.0.Beta2.jar
	transformer_cp=${transformer_cp}:${cd_modules}com/google/appengine/main/appengine-api-1.0-sdk-1.7.3.jar
	...
	${cd_modules}com/google/appengine/main/appengine-api-1.0-sdk-1.7.3.jar
}
