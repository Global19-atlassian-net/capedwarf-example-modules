...
function cd_transformer {
	...
	transformer_cp=${transformer_cp}:${cd_modules}com/google/appengine/main/appengine-api-1.0-sdk-1.7.4.jar
	...
	${cd_modules}com/google/appengine/main/appengine-api-1.0-sdk-1.7.4.jar
}
